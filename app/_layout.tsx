...
import { Appearance } from "react-native"; // Import for detecting system theme
  ...
  return (
    <>
      ...
      <StatusBar 
        ...
        backgroundColor={isDarkMode ? darkColors.background : "background"} // Set background color based on dark/light mode
      />
